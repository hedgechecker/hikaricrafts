  ...
  return (
    <div className={styles.page}>
      <NavBar selected={0} />
        ...
        <p> Diese Seite is noch in der Entstehungsphase und dient nur als Vorschau verschiedener Produkte.
            Wenn Sie Fehler/Bugs oder nervige Kleinigkeiten finden würde es mir sehr helfen, wenn Sie diese 
